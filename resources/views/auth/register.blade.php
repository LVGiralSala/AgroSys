            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tipo_identificacion" class="col-md-4 col-form-label text-md-right">{{ __('tipo_identificacion') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="num_identificacion" class="col-md-4 col-form-label text-md-right">{{ __('num_identificacion') }}</label>

                            <div class="col-md-6">
                                <input id="num_identificacion" type="text" class="form-control @error('num_identificacion') is-invalid @enderror" name="num_identificacion" value="{{ old('num_identificacion') }}" required autocomplete="num_identificacion" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="id_cargo" class="col-md-4 col-form-label text-md-right">{{ __('id_cargo') }}</label>

                            <div class="col-md-6">
                                <input id="id_cargo" type="text" class="form-control @error('id_cargo') is-invalid @enderror" name="id_cargo" value="{{ old('id_cargo') }}" required autocomplete="id_cargo" autofocus>
